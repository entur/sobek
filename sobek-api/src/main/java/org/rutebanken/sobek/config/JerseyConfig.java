...
public class JerseyConfig {
    ...
    public static final String SERVICES_VEHICLES_PATH = SERVICES_PATH + "/vehicles";
    ...
    public ServletRegistrationBean publicJersey() {
        ...
        publicServicesJersey.addUrlMappings(SERVICES_VEHICLES_PATH + "/*");
        ...
        publicServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.rutebanken.sobek");
    ...
    public ServletRegistrationBean healthJersey() {
        ...
        healthServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.rutebanken.sobek");
    ...
    public ServletRegistrationBean prometheusJersey() {
        ...
        prometheusServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.rutebanken.sobek");
    ...
    public ServletRegistrationBean adminJersey() {
        ...
        adminServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.rutebanken.sobek");
    ...
    public ServletRegistrationBean vehiclesJersey() {
        ...
        vehiclesServicesJersey.getInitParameters().put("jersey.config.server.provider.packages", "org.rutebanken.sobek");

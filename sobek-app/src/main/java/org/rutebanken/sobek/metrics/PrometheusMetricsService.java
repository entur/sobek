...
public class PrometheusMetricsService {
    ...
    private static final String METRICS_PREFIX = "app.sobek.";
    ...
    public void registerRequestFromClient(String clientName, String clientId, long total) {
        ...
        meterRegistry.counter(CLIENT_COUNTER, counterTags).increment(total);
    }
    ...
    public void registerRequestFromUser(String userName, long total) {
        ...
        meterRegistry.counter(USER_COUNTER, counterTags).increment(total);
    }
    ...
    public void registerEntitySaved(Class<? extends IdentifiedEntity> entityClass, long total) {
        ...
        meterRegistry.counter(ENTITY_COUNTER, counterTags).increment(total);
    }
}

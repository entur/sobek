...
import org.rutebanken.sobek.rest.exception.ErrorResponseEntity;
...
public class GraphQLResource {
    ...
    @Autowired
    private RegisterGraphQLSchema vehicleRegisterGraphQLSchema;
    ...
    public void init() {
        ...
        graphQL = GraphQL.newGraphQL(vehicleRegisterGraphQLSchema.vehicleRegisterSchema)
            ...
            try {
                content.put("errors", errors.stream().map(graphQLError -> {
                    if (graphQLError instanceof ExceptionWhileDataFetching) {
                        return new SobekExceptionWhileDataFetching((ExceptionWhileDataFetching) graphQLError);
                    } else if( graphQLError instanceof AbortExecutionException) {
                        return new SobekExceptionMaxDepth((AbortExecutionException) graphQLError);
                    }
                    else {
                        return graphQLError;
                    }

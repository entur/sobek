 ...
 */
public class SobekExceptionWhileDataFetching implements GraphQLError {

    private final ExceptionWhileDataFetching exceptionWhileDataFetching;

    public SobekExceptionWhileDataFetching(ExceptionWhileDataFetching exceptionWhileDataFetching) {

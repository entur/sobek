...
@Transactional
@Component
public class DeckPlanNeTExIdConverter extends GenericNeTExIdConverter<DeckPlan> {

    public DeckPlanNeTExIdConverter(ValidPrefixList validPrefixList, NetexIdHelper netexIdHelper, GenericEntityInVersionRepository genericEntityInVersionRepository) {

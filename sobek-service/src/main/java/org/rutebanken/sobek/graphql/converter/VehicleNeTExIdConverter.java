...
@Transactional
@Component
public class VehicleNeTExIdConverter extends GenericNeTExIdConverter<Vehicle> {

    public VehicleNeTExIdConverter(ValidPrefixList validPrefixList, NetexIdHelper netexIdHelper, GenericEntityInVersionRepository genericEntityInVersionRepository) {

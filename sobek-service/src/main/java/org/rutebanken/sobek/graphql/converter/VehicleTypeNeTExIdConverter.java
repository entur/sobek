...
@Transactional
@Component
public class VehicleTypeNeTExIdConverter extends GenericNeTExIdConverter<VehicleType> {

    public VehicleTypeNeTExIdConverter(ValidPrefixList validPrefixList, NetexIdHelper netexIdHelper, GenericEntityInVersionRepository genericEntityInVersionRepository) {

...
public class OAuth2Config {
    ...
    public MultiIssuerAuthenticationManagerResolver multiIssuerAuthenticationManagerResolver(
            ...
            @Value("${sobek.oauth2.resourceserver.auth0.ror.jwt.audience:}")
            String rorAuth0Audience,
            @Value("${sobek.oauth2.resourceserver.auth0.ror.jwt.issuer-uri:}")
            String rorAuth0Issuer,
            @Value("${sobek.oauth2.resourceserver.auth0.ror.claim.namespace:}")

...
import org.rutebanken.sobek.netex.mapping.NetexMappingContextThreadLocal;
...
@Component
public class ValidBetweenConverter extends BidirectionalConverter<List<ValidBetween>, org.rutebanken.sobek.model.ValidBetween> {
    ...
    @Override
    public org.rutebanken.sobek.model.ValidBetween convertTo(List<ValidBetween> validBetweens, Type<org.rutebanken.sobek.model.ValidBetween> type, MappingContext mappingContext) {
        ...
        org.rutebanken.sobek.model.ValidBetween sobekValidBetween = new org.rutebanken.sobek.model.ValidBetween();
        if (netexValidBetween.getFromDate() != null) {
            sobekValidBetween.setFromDate(Instant.from(netexValidBetween.getFromDate().atZone(mappingTimeZone)));
        }
        if (netexValidBetween.getToDate() != null) {
            sobekValidBetween.setToDate(Instant.from(netexValidBetween.getToDate().atZone(mappingTimeZone)));
        }

        return sobekValidBetween;
    }

    @Override
    public List<ValidBetween> convertFrom(org.rutebanken.sobek.model.ValidBetween validBetween, Type<List<ValidBetween>> type, MappingContext mappingContext) {

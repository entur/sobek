...
public class NetexMapperTest extends SobekIntegrationTest {
//
//    @Autowired
...
//                );
//
//        StopPlace sobekStopPlace = netexMapper.mapToSobekModel(stopPlace);
//
//
//        assertThat(sobekStopPlace.getOriginalIds())
//                .hasSize(3);
//
//    }
//
...
//        org.rutebanken.sobek.model.SiteFrame sourceSiteFrame = new org.rutebanken.sobek.model.SiteFrame();
//
...
//
//        org.rutebanken.sobek.model.SiteFrame actualSiteFrame = netexMapper.mapToSobekModel(netexSiteFrame);
//
...
//
//        org.rutebanken.sobek.model.StopPlace sobekStopPlace = netexMapper.mapToSobekModel(netexStopPlace);
//
//        assertThat(sobekStopPlace).isNotNull();
//        assertThat(sobekStopPlace.getNetexId()).isEqualTo(netexStopPlace.getId());
//    }
//
//    @Test
...
//     * But when the stop place already has key values, we should map them to sobek's keyValues.
//     */
//    @Test
//    public void mapStopPlaceWithKeyValuesToSobek() throws Exception {
//        String originalId = "OPP:StopArea:123";
//        org.rutebanken.netex.model.StopPlace netexStopPlace = new org.rutebanken.netex.model.StopPlace()
//                .withKeyList(
...
//
//        StopPlace sobekStopPlace = netexMapper.mapToSobekModel(netexStopPlace);
//        assertThat(sobekStopPlace.getKeyValues()).isNotNull();
//        assertThat(sobekStopPlace.getKeyValues()).containsKey(ORIGINAL_ID_KEY);
//        assertThat(sobekStopPlace.getKeyValues().get(ORIGINAL_ID_KEY).getItems().contains(originalId));
//    }
//
//    @Test
...
//
//        assertThat(sobekStopPlace).isNotNull();
//        assertThat(sobekStopPlace.getName().getValue()).isEqualTo(netexStopPlace.getName().getValue());
//
//    }
//
//    @Test
//    public void mapStopPlaceInternalIdToNetexId() {
//        StopPlace sobekStopPlace = new StopPlace();
//        sobekStopPlace.setNetexId("NSR:StopPlace:123456");
//
//        org.rutebanken.netex.model.StopPlace netexStopPlace = netexMapper.mapToNetexModel(sobekStopPlace);
//
...
//
//        org.rutebanken.sobek.model.Quay sobekQuay = netexMapper.mapToSobekModel(netexQuay);
//
//        assertThat(sobekQuay.getNetexId()).isEqualTo("NSR:Quay:12345");
//    }
//
//    @Test
//    public void mapInternalQuayIdToNetex() {
//
//        org.rutebanken.sobek.model.Quay sobekQuay = new org.rutebanken.sobek.model.Quay();
//        String netexId = "NSR:Quay:" + 1234567;
//        sobekQuay.setNetexId(netexId);
//
//        org.rutebanken.netex.model.Quay netexQuay = netexMapper.mapToNetexModel(sobekQuay);
...
//        org.rutebanken.sobek.model.StopPlace stopPlace = new StopPlace();
//
//        String netexId = "NSR:Quay:" + 1234567;
//        org.rutebanken.sobek.model.Quay sobekQuay = new org.rutebanken.sobek.model.Quay();
//        sobekQuay.setNetexId(netexId);
//
//        stopPlace.getQuays().add(sobekQuay);
//
...
//        SiteFrame sobekSiteFrame = new SiteFrame();
...
//
//        org.rutebanken.netex.model.SiteFrame netexSiteFrame = netexMapper.mapToNetexModel(sobekSiteFrame);
//
//
//        assertThat(netexSiteFrame).isNotNull();
...
//
//    @Test
//    public void mapCountyRefsFromMunicipalitiesFromSobekToNetex() {
//        SiteFrame sobekSiteFrame = new SiteFrame();
//
//        CountryRef countryRef = new CountryRef();
//        countryRef.setRef(IanaCountryTldEnumeration.ZM);
...
//
//    @Test
//    public void mapCountyRefsFromMunicipalitiesFromNetexToSobek() {
//        org.rutebanken.netex.model.SiteFrame netexSiteFrame = new org.rutebanken.netex.model.SiteFrame();
...
//        TopographicPlace sobekCounty = new TopographicPlace(new EmbeddableMultilingualString(county.getName().getValue()));
//        sobekCounty.setNetexId(county.getId());
//        topographicPlaceRepository.save(sobekCounty);
//
//        TopographicPlace sobekMunicipality = new TopographicPlace(new EmbeddableMultilingualString(municipality.getName().getValue()));
//        sobekMunicipality.setNetexId(municipality.getId());
//        sobekMunicipality.setParentTopographicPlaceRef(new TopographicPlaceRefStructure(sobekCounty));
//        topographicPlaceRepository.save(sobekMunicipality);
//
//
//        SiteFrame sobekSiteFrame = netexMapper.mapToSobekModel(netexSiteFrame);
//
//        assertThat(netexSiteFrame).isNotNull();
//        assertThat(netexSiteFrame.getTopographicPlaces().getTopographicPlace()).isNotEmpty();
//
//        TopographicPlace actualSobekMunicipality = sobekSiteFrame.getTopographicPlaces().getTopographicPlace().getFirst();
//        assertThat(actualSobekMunicipality).isNotNull();
//        assertThat(actualSobekMunicipality.getParentTopographicPlaceRef())
//                .describedAs("The municipality should have a parent topographic place").isNotNull();
//        assertThat(actualSobekMunicipality.getParentTopographicPlaceRef().getRef()).isEqualTo(county.getId());
//    }
//
//
//    @Test
//    public void mapStopPlaceWithAccessibilityAssessmentToSobek() {
//        org.rutebanken.netex.model.StopPlace netexStopPlace = new org.rutebanken.netex.model.StopPlace();
...
//
//        assertThat(sobekStopPlace).isNotNull();
//        assertThat(sobekStopPlace.getAccessibilityAssessment()).isNotNull();
//        assertThat(sobekStopPlace.getAccessibilityAssessment().getLimitations()).isNotNull();
//    }
//
...
//        StopPlace sobekStopPlace = new StopPlace();
//        sobekStopPlace.setAccessibilityAssessment(createAccessibilityAssessment());
//
//        assertThat(sobekStopPlace.getAccessibilityAssessment()).isNotNull();
//        assertThat(sobekStopPlace.getAccessibilityAssessment().getLimitations()).isNotNull();
//

...
public class DataManagedObjectStructureMapperTest {
    ...
    public void mappingChangedByFromNetex() {
        ...
        dataManagedObjectStructureMapper.mapAtoB(netexVehicle, sobekVehicle, mappingContext);

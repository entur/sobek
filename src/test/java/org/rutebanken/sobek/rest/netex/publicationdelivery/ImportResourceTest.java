...
//
public class ImportResourceTest extends SobekIntegrationTest {
...
//        importParams.ignoreStopTypes = Sets.newHashSet(org.rutebanken.sobek.model.StopTypeEnumeration.BUS_STATION);
//        PublicationDeliveryStructure publicationDelivery = publicationDeliveryTestHelper.createPublicationDeliveryWithStopPlace(stopPlace);
...
//
//        ImportParams importParams = new ImportParams();
//        importParams.allowOnlyStopTypes = Sets.newHashSet(org.rutebanken.sobek.model.StopTypeEnumeration.METRO_STATION);
...
//
//        ImportParams importParams = new ImportParams();
//        importParams.forceStopType = org.rutebanken.sobek.model.StopTypeEnumeration.BUS_STATION;
//        PublicationDeliveryStructure publicationDelivery = publicationDeliveryTestHelper.createPublicationDeliveryWithStopPlace(stopPlace);
//        PublicationDeliveryStructure response = publicationDeliveryTestHelper.postAndReturnPublicationDelivery(publicationDelivery, importParams);
//        List<StopPlace> result = publicationDeliveryTestHelper.extractStopPlaces(response);
//
...
//
//        final FileInputStream fileInputStream = new FileInputStream("src/test/resources/org/rutebanken/sobek/rest/netex/publicationdelivery/brakar.xml");
//
...
//        final org.rutebanken.sobek.model.StopPlace stopPlace = new org.rutebanken.sobek.model.StopPlace();
//        stopPlace.setNetexId("NSR:StopPlace:408");
//        stopPlace.setVersion(1);
//        stopPlaceRepository.save(stopPlace);
//
//        final FileInputStream fileInputStream = new FileInputStream("src/test/resources/org/rutebanken/sobek/rest/netex/publicationdelivery/parking.xml");
//
//        Response response = importResource.importPublicationDelivery(fileInputStream);
//        assertThat(response.getStatus()).isEqualTo(200);
//
